...
class LocalNotificationsManager {
  ...
  LocalNotificationsManager(ReactApplicationContext reactContext) {
    this(reactContext.getApplicationContext());
    this.reactContext = reactContext;
  }

  LocalNotificationsManager(Context context) {
  ...
  void cancelAllNotifications(Promise promise) {
    try {
      ...
      // In some devices/situations cancelAllLocalNotificationss can throw a SecurityException.
  ...
  private void cancelAlarm(String notificationId) {
    Intent notificationIntent = new Intent(context, LocalNotificationsReceiver.class);
  ...
  private void displayNotification(Bundle notification, Promise promise) {
    new DisplayLocalNotificationsTask(
      context,
      reactContext,
      notificationManager,
      notification,
